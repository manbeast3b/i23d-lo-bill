...
class Settings(BaseSettings):
    ...
    qwen_edit_height: int = Field(default=768, env="QWEN_EDIT_HEIGHT")
    qwen_edit_width: int = Field(default=768, env="QWEN_EDIT_WIDTH")
    ...
    input_image_size: tuple[int, int] = Field(default=(768, 768), env="INPUT_IMAGE_SIZE") # (height, width)
